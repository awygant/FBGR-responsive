...
<html lang="en">
<head>
    <title>Free Background Removal | About</title>
...
<div id = "container">
    ...
    <div id = "wrap" class = "text-center">
        ...
        <div id = "main">
            <div class = "grey-panel text-center">
                <h2>ABOUT</h2>
                <p>powered by</p>
                <a href = "http://www.flashfotoinc.com" target = "_blank"><img class = "about-logo" src = "img/logos/ff-color.png" width = "200" alt = "Flashfoto Logo"/></a>
                <p>
